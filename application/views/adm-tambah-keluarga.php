...
<head>
    ...
    <title>Tambah Paket Wisata Keluarga </title>
                    ...
                    <div class="row match-height">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> Tambah Data Paket Wisata Keluarga</h4>
                                </div>
                                <form action="<?php echo base_url('c_travelbaliku/addpaketkeluarga')?>" method = "POST">
