  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 ftco-animate py-md-5 mt-md-5">
        ...
        <p>
          <img src="<?= base_url('th1/images/bg_5.jpg')?>" alt="" class="img-fluid">
        </p>
        ...
        <p>
          <img src="<?= base_url('th1/images/bg_1.jpg')?>" alt="" class="img-fluid">
        </p>
        <p>Quisquam esse aliquam fuga distinctio, quidem delectus veritatis reiciendis. Nihil explicabo quod, est eos ipsum. Unde aut non tenetur tempore, nisi culpa voluptate maiores officiis quis vel ab consectetur suscipit veritatis nulla quos quia aspernatur perferendis, libero sint. Error, velit, porro. Deserunt minus, quibusdam iste enim veniam, modi rem maiores.</p>

        <div class="about-author d-flex p-4 bg-light">
          <div class="bio mr-5">
            <img src="<?= base_url('th1/images/person_1.jpg')?>" alt="Image placeholder" class="img-fluid mb-4">
          </div>
          <div class="desc">
      ...
      <div class="col-lg-4 sidebar ftco-animate bg-light py-md-5">
        ...
        <div class="sidebar-box ftco-animate">
          ...
          <div class="block-21 mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url(<?= base_url('th1/images/image_1.jpg')?>);"></a>
            <div class="text">
          ...
          <div class="block-21 mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image:  url(<?= base_url('th1/images/image_2.jpg')?>);"></a>
            <div class="text">
              <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
              <div class="meta">
                <div><a href="#"><span class="fa fa-calendar"></span> September 11, 2020</a></div>
          ...
          <div class="block-21 mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url(<?= base_url('th1/images/image_3.jpg')?>);"></a>
            <div class="text">
              <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
              <div class="meta">
                <div><a href="#"><span class="fa fa-calendar"></span> September 11, 2020</a></div>
...
<h1 style="text-align: center; font-size: 40px; color: #f15d30;">LAKUKAN PEMESANAN</h1>
  ...
  <div class="container">
    <div class="row block-9">
      ...
      <div class="col-md-6 d-flex">
       <div class="bg-white"> <img src="<?= base_url('th1/images/destination-10.jpg')?>" alt="" class="img-fluid"></div>
     </div>
   </div>
 </div>
</section>
...
<footer class="ftco-footer bg-bottom ftco-no-pt" style="background-image: url(<?= base_url('th1/images/bg_3.jpg')?>);">
  <div class="container">
    <div class="row mb-5">
