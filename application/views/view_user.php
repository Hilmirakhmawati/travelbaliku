                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Pengguna</h3>
                            <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/tambahuser')?>">Tambah</a><br><br>
                        </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                <?php foreach ($pengguna -> result_array() as $key):?>
                                                <tr>
                                                    <td class="text-bold-500"><?php echo $key['id_user']?></td>
                                                    <td><?php echo $key['email']?></td>
                                                    <td class="text-bold-500"><?php echo $key['nama']?></td>
                                                    ...
                                                    <td>
                                                        <a href="#">
                                                          ...
                                                          <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/ubahuser/'.$key['id_user'])?>">Edit</a>
                                                         <a class="btn btn-danger" href="<?php echo base_url('c_travelbaliku/deleteuser/'.$key['id_user'])?>">Delete</a>
                                                    </td>
