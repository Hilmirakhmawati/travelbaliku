                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/tambahpaket')?>">Tambah</a><br><br>
                        </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                             <?php foreach ($paket -> result_array() as $key):?>
                                                <tr>
                                                    <td class="text-bold-500"><?php echo $key['kode_paket']?></td>
                                                    <td><?php echo $key['nama_paket']?></td>
                                                    <td class="text-bold-500"><?php echo $key['kategori']?></td>
                                                    <td><?php echo $key['harga_paket']?></td>
                                                    <td><?php echo $key['deskripsi']?></td>
                                                    <td><?php echo $key['hotel']?></td>
                                                    <td><?php echo $key['fasilitas']?></td>
                                                    <td><?php echo $key['tempat_wisata']?></td>
                                                    ...
                                                    <td>
                                                        <a href="#">
                                                          ...
                                                          <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/ubahpaket/'.$key['kode_paket'])?>">Edit</a><br><br>
                                                         <a class="btn btn-danger" href="<?php echo base_url('c_travelbaliku/deletepaket/'.$key['kode_paket'])?>">Delete</a>
                                                    </td>
