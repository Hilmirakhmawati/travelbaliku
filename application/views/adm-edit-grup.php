                    ...
                    <div class="row match-height">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> Edit Data Paket Wisata Grup</h4>
                                </div>
                                <?php foreach ($datapaketgrup->result_array() as $dgrp)?>
                                <form class="forms-sample" action="<?php echo base_url('c_travelbaliku/editpaketgrup/').$dgrp['id-grup']?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" readonly name = "id-grup" value="<?php echo $dgrp['id-grup']?>">
                                                            <input type="text" id="first-name-vertical"
                                                                class="form-control" name="nama-paket"
                                                                placeholder=" Nama Paket" value="<?php echo $dgrp['nama-paket']?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical"
                                                                ...
                                                                placeholder="Harga" value="<?php echo $dgrp['harga-paket']?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical"
                                                                ...
                                                                placeholder="Deskripsi" value="<?php echo $dgrp['deskripsi']?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical"
                                                                ...
                                                                placeholder="Hotel" value="<?php echo $dgrp['hotel']?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical"
                                                                ...
                                                                placeholder="Fasilitas" value="<?php echo $dgrp['fasilitas']?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical"
                                                                ...
                                                                placeholder="Tempat Wisata" value="<?php echo $dgrp['tempat-wisata']?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical"
                                                                ...
                                                                placeholder="tempat-makan" value="<?php echo $dgrp['tempat-makan']?>">
                                                        </div>
                                                    </div>
