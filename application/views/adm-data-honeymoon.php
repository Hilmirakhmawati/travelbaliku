                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Paket Wisata Honeymoon</h3>
                            <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/tambahpakethoneymoon')?>">Tambah</a><br><br>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Data Paket Wisata Honeymoon</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                             <?php foreach ($admvhoneymoon -> result_array() as $key):?>
                                                <tr>
                                                    <td class="text-bold-500"><?php echo $key['id-honeymoon']?></td>
                                                    ...
                                                    <td>
                                                        <a href="#">
                                                          ...
                                                          <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/ubahpakethoneymoon/'.$key['id-honeymoon'])?>">Edit</a><br><br>
                                                         <a class="btn btn-danger" href="<?php echo base_url('c_travelbaliku/deletepakethoneymoon/'.$key['id-honeymoon'])?>">Delete</a>
                                                    </td>
