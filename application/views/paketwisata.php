  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
         <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span>List Paket Wisata <i class="fa fa-chevron-right"></i></span></p>
         <h1 class="mb-0 bread">List Paket</h1>
     </div>
 </div>
</div>
</section>
            ...
            <div class="row">
               <div class="col-md-4 ftco-animate">
                  <div class="project-wrap">
                     <a href="<?php echo base_url('c_travelbaliku/vpaketwisata')?>" class="img" style="background-image: url(../th1/images/destination-1.jpg);">
