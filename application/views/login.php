        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <h1 style="margin-left : 80px; margin-top : -60px;">TRAVELBALIKU</h1>
              <p class="login-card-description" style=" font-size: 25px;">Masuk</p>
              <form action="<?php echo base_url('c_travelbaliku/login')?>" method = "POST">
                ...
                <p class="login-card-footer-text">Belum punya akun? <a href="<?php echo base_url('c_travelbaliku/registertravel')?>" class="text-reset">Daftar disini</a></p>
