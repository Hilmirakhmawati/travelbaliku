...
<head>
    ...
    <title>Data Paket Keluarga</title>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Paket Wisata Keluarga</h3>
                            <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/tambahpaketkeluarga')?>">Tambah</a><br><br>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Data Paket Wisata Keluarga</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                             <?php foreach ($admvkeluarga -> result_array() as $key):?>
                                                <tr>
                                                    <td class="text-bold-500"><?php echo $key['id-keluarga']?></td>
                                                    ...
                                                    <td>
                                                        <a href="#">
                                                          ...
                                                          <a class="btn btn-primary" href="<?php echo base_url('c_travelbaliku/ubahpaketkeluarga/'.$key['id-keluarga'])?>">Edit</a><br><br>
                                                         <a class="btn btn-danger" href="<?php echo base_url('c_travelbaliku/deletepaketkeluarga/'.$key['id-keluarga'])?>">Delete</a>
                                                    </td>
